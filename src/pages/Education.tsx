...
const education: EducationEntry[] = [
  ...
  },
  {
    ...
    period: "2020 - 2022",
    location: "Moodabidri, India",
    details: "Focused on Computer Science, Mathematics, Physics, and Chemistry.",
    icon: Briefcase,
    accent: "#a78bfa",
    tag: "PUC",
  },
  {
    id: "school",
    institution: "Our Lady of Pompei English Medium School",
    short: "Pompei",
    degree: "SSLC (Class 1-10)",
    period: "2010 - 2020",
    location: "Mangalore, India",
    details: "Completed foundational primary and secondary education.",
    icon: School,
    accent: "#fb923c",
    tag: "Schooling",
  },
