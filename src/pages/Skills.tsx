...
const skillCategories: SkillCategory[] = [
  {
    ...
    icon: Code2,
    accent: "#38bdf8",
    skills: ["AWS", "EC2", "S3", "VPC", "IAM", "Route 53", "Terraform"],
  ...
  {
    id: "Operating Systems & Networking",
...

  {
    ...
    icon: Code2,
    accent: "#38bdf8",
    skills: ["Git", "Github", "Postman", "Selenium WebDriver", "TestNG"],
    blurb: "What Tools I use",
  },
];
